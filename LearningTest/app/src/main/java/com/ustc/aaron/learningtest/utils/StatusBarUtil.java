...
public class StatusBarUtil {
    ...
    public static void setDrawable(Activity activity, Drawable drawable) {
        setDrawable(activity, drawable, DEFAULT_STATUS_BAR_ALPHA);
    }
...
//        removeMoreStatusView(activity);
    ...
    private static void removeMoreStatusView(Activity context) {
    ...
    public static void setDrawable(Activity activity, Drawable drawable, int statusBarAlpha) {
